                    ...
                    >
                        ...
                        <div className={styles.infoItem}>
                            ...
                            <div>
                                ...
                                <a href="tel:+923006666643" className={styles.infoValue}>+92 300 6666643</a>
                            </div>
                        </div>
                        ...
                        <div className={styles.infoItem}>
                            ...
                            <div>
                                ...
                                <a href="https://wa.me/923006666643" target="_blank" rel="noopener noreferrer" className={styles.infoValue}>
                                    Chat on WhatsApp
                                </a>
                            </div>
                        </div>
                        ...
                        <div className={styles.infoItem}>
                            ...
                            <div>
                                ...
                                <a href="mailto:info@masrentacar.com" className={styles.infoValue}>
                                    info@masrentacar.com
                                </a>
                            </div>
                        </div>
                        ...
                        <div className={styles.infoItem}>
                            ...
                            <div>
                                ...
                                <span className={styles.infoValue}>Street 1, near Gold crest mall sector DD phase 4 Dha lahore, Sector DD Dha Phase 4, Lahore, 54810</span>
                            </div>
                        </div>
                        ...
                        <div className={styles.infoItem}>
                            ...
                            <div>
                                ...
                                <a href="https://share.google/C0zHqaP9NRdsIDznc" target="_blank" rel="noopener noreferrer" className={styles.infoValue} style={{ color: 'var(--primary)', textDecoration: 'underline' }}>
                                    View on Google
                                </a>
                            </div>
                        </div>
