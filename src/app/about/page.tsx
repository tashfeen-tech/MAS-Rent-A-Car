...
const VALUES = [
    ...
    },
    {
        ...
        desc: "Hundreds of satisfied customers trust MAS for their travel needs every month.",
    },
];
        ...
        <>
            ...
            <div className={styles.page}>
                ...
                <div className={styles.heroBanner}>
                    ...
                    >
                        About <span className="gradient-text">MAS</span>
                    </motion.h1>
                    <motion.p
                ...
                <section className={styles.storySection}>
                    ...
                    >
                        ...
                        <p>
                            MAS Rent A Car was founded with a single vision: to bring luxury, reliability,
                        ...
                        <p>
                            ...
                            MAS ensures you arrive in style.
                        </p>
                        <p>
                ...
                <section className={styles.cta}>
                    ...
                    <p>Book your vehicle today and experience the MAS difference.</p>
